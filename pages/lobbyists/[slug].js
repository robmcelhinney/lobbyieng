        ...
        <header className="hero-shell">
          <div className="max-w-7xl mx-auto px-4 py-8 text-center">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 mt-4 rounded-full border border-white/20 bg-white/10 px-4 py-2 text-sm font-semibold text-white shadow-sm backdrop-blur transition hover:bg-white/15 hover:border-white/30"
            >
