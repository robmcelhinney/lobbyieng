      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
        <header className="bg-blue-900 dark:bg-gray-800 text-white dark:text-gray-100 py-4">
          <div className="max-w-6xl mx-auto px-4 text-center">
            ...
            <p className="mt-1">
              Select two officials to compare their lobbying connections.
            </p>
          </div>
        </header>
        <main className="max-w-6xl mx-auto px-4 py-8">
          <div className="mb-8 p-4 bg-white dark:bg-gray-800 rounded shadow text-left">
            ...
            <p className="mb-2">
              The Chord Diagram lets you compare the lobbying connections of any
              two Irish officials. Select two officials and a time range to see
              which lobbyists have interacted with both, and how frequently. The
              diagram visualizes shared and individual lobbying activity,
              helping you explore overlaps and relationships in lobbying
              efforts. Use the filters below to adjust the time period and
              number of lobbyists shown.
            </p>
          </div>
          <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-md shadow-md p-8 flex flex-col items-center">
            ...
            <p className="mt-4 text-gray-600 dark:text-gray-300 text-sm">
              This diagram shows the relationships between lobbyists and the two
              selected officials. The thickness of each ribbon represents the
              number of lobbying records between a lobbyist and an official.
            </p>
          </div>
        </main>
      </div>
